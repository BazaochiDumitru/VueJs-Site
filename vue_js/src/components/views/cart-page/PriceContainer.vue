  ...
  <div>
    ...
    <div class="form__container">
      <form class="form-inline">
        ...
        <input type="text" id="name" placeholder="Enter name" name="name" v-model="name"/>
        <label for="email">Email:</label>
        <input type="email" id="email" placeholder="Enter email" name="email" v-model="email"/>
        <label for="phone">Phone:</label>
        <input type="tel" id="phone" placeholder="Enter phone" name="phone" v-model="phone"/>
        ...
        <select id="city" name="city" style="height: 40px" v-model="selectedCity">
        ...
        <select id="delivery" name="city" style="height: 40px" v-model="shippingPrice">
        ...
        <select id="payment" name="payment" style="height: 40px" v-model="paymentMethod">
